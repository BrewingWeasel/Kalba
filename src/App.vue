...
<template>
   <div class="flex w-full">
     <NavigationMenu>
       <NavigationMenuList>
         ...
         <NavigationMenuItem>
           <NavigationMenuLink href="/words" :class="navigationMenuTriggerStyle()">
             Dictionary
           </NavigationMenuLink>
         </NavigationMenuItem>
         <NavigationMenuItem>
     ...
     <div class="pt-1 pr-8 ml-auto">
        <Popover>
          ...
          <h4 class="pb-2 font-medium leading-none">
             Quick Settings
          </h4>
          <Label for="current-language">Current language:</Label>
          <Select id="current-language" :modelValue="currentLanguage ?? undefined" @update:model-value="$event => {setLanguage($event.value); currentLanguage = $event.value}">
  ...
  <Suspense>
    <router-view :currentLanguage="currentLanguage" @settingsChanged="updateLanguages"></router-view>
  </Suspense>
</template>
